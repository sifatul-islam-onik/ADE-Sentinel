...
cells = [
    ...
    code("DATASET_VERSION = ''   # <- fill in, e.g. 'ade-sentinel-artifacts v1'",
         ...
         "",
         "",
         "# Both layouts: files dragged straight into a Dataset land in its root,",
         "# while an uploaded folder (or a zip) keeps the emb_matrices/ level.",
         "candidates = []",
         "if ON_KAGGLE:",
         ...
         "",
         "if MATRICES is None:",
         "    searched = '\\n'.join(f'    {d}' for d in candidates if d.is_dir())",
         "    raise SystemExit(",
         "        'No directory with both vocab.json and E*.npy was found. Searched:\\n'",
         "        f'{searched}\\n\\n'",
         "        'Fix: Kaggle -> Datasets -> New Dataset, upload ALL FIVE files from '",
         "        'models/emb_matrices/ (E0_random.npy, E1.npy, E2.npy, E3.npy, '",
